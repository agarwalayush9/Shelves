...
struct BorrowBookDetailInterfaceView: View {
                    ...
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack(spacing: 16) {
                            VStack(alignment: .leading, spacing: 10) {
                                ScrollView(.horizontal, showsIndicators: false) {
                                    HStack(spacing: 20) {
                                        CustomBorrowBookView(title: "The Good Guy", author: "Author Name", subtitle: "Subtitle goes here", imageName: "book1")
                                        CustomBorrowBookView(title: "Really Good, Actually", author: "Monica Heisey", subtitle: "Subtitle goes here", imageName: "book2")
                                        CustomBorrowBookView(title: "A Brief History of Time", author: "Stephen Hawking", subtitle: "From the Big Bang to Black Holes", imageName: "book")
                                        CustomBorrowBookView(title: "Who We Are and How We", author: "David Reich", subtitle: "Ancient DNA and the New Science of Human", imageName: "book4")
                                    }
...
struct CustomBorrowBookView: View {
    var title: String
    var author: String
    var subtitle: String
...
struct BorrowBookDetailView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            BorrowBookDetailInterfaceView()
                .preferredColorScheme(.light)
            BorrowBookDetailInterfaceView()             .preferredColorScheme(.dark)
        }
    }
}
